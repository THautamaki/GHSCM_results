...
writematrix(a_mat, "..\..\Results_files\CEU_dataset\CEU_data_npn_GHS_MCMC_Theta.txt")
...
%% Write the adjacency matrix into text file.
writematrix(a_mat, "..\..\Results_files\CEU_dataset\CEU_data_npn_GHSl_ECM_Theta.txt")
